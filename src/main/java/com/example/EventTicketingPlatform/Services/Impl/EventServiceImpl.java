...
import com.example.EventTicketingPlatform.Exceptions.EventNotFoundException;
import com.example.EventTicketingPlatform.Exceptions.EventUpdateException;
...
public class EventServiceImpl implements EventService {
    ...
    public Page<Event> listPublishedEvents(Pageable pageable) {
        return eventRepository.findByStatus(EventStatuEnum.PUBLISHED, pageable);
    }

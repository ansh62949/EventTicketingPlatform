...
const DashboardManageEventPage: React.FC = () => {
  ...
  const [eventStartDateEnabled, setEventStartDateEnabled] = useState(false);
  const [eventEndDateEnabled, setEventEndDateEnabled] = useState(false);
  const [eventSalesStartDateEnabled, setEventSalesStartDateEnabled] = useState(false);
  const [eventSalesEndDateEnabled, setEventSalesEndDateEnabled] = useState(false);
  ...
  useEffect(() => {
    if (isEditMode && !isLoading && user?.access_token) {
      const fetchEvent = async () => {
        ...
        setEventStartDateEnabled(!!event.start);
        setEventEndDateEnabled(!!event.end);
        setEventSalesStartDateEnabled(!!event.salesStart);
        setEventSalesEndDateEnabled(!!event.salesEnd);
      };
      fetchEvent();
    }
  }, [id, user]);
        ...
        <form onSubmit={handleFormSubmit} className="space-y-4">
          ...
          <div>
            ...
            <DateTimeSelect
              ...
              enabled={eventStartDateEnabled}
              setEnabled={setEventStartDateEnabled}
            />
            <p className="text-gray-400 text-xs">
          ...
          <div>
            ...
            <DateTimeSelect
              ...
              enabled={eventEndDateEnabled}
              setEnabled={setEventEndDateEnabled}
            />
            <p className="text-gray-400 text-xs">
          ...
          <div>
            ...
            <DateTimeSelect
              ...
              enabled={eventSalesStartDateEnabled}
              setEnabled={setEventSalesStartDateEnabled}
            />
            <p className="text-gray-400 text-xs">
          ...
          <div>
            ...
            <DateTimeSelect
              ...
              enabled={eventSalesEndDateEnabled}
              setEnabled={setEventSalesEndDateEnabled}
            />
            <p className="text-gray-400 text-xs">
              The date and time that ticket are available to purchase for the
              event.
